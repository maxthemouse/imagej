...
macro "Vertical Scan Image View, ver1.3.0" {
...
imageCalculator("Subtract create 32-bit", "flatimage", "darkimage");
...
for (i=0; i<Imgcount; i++) {                                                    /////////loop for loading the individual files from the selected folder;
	...
	open(Singleimgpath);	
	imageCalculator("Subtract create 32-bit", Imglist[i],"darkimage");
